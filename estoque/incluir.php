  ...
  <div class="d-flex" id="wrapper">
    ...
    <div id="page-content-wrapper">
      ...
      <div class="container-fluid">
        <h1 class="mt-4 text-warning">Incluir Ítem <i class="fas fa-arrow-circle-down"></i></h1>
        <form id="incluir" action="" method="post">     
          <div class="form-group">            
            <div class="row">
              <div class="col-sm-8 col-md-8 col-lg-8">
                <label for="incluir-peca">Nome do Ítem</label>           
        ...
        <div class="col-sm-8 col-md-8 col-lg-8">
            <p>Antes de incluir algum ítem, certifique-se de que já não exista este ítem na lista do estoque, evitando assim, cadastro em duplicidade</p>
            <p>Cadastre o ítem usando nome técnico, de forma que todos conheçam.</p>
            <p>Esta inclusão apenas informa ao sistema a existência deste ítem, não exclui a necessidade de dar entrada através da guia <a href="entradas.html">Entradas</a></p>
        </div>
        <div id="loaded"></div>
